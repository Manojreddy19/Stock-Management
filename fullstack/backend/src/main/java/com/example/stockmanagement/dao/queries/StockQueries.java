...
public class StockQueries {
	...
	protected static  String SELECT_ALL_PRODUCT_IDS ="SELECT DISTINCT ProductId FROM tbl_stock_master WHERE 1=1 AND (:flag=1 OR Quantity > 0 ) AND (:productFlag=1 OR ProductId LIKE :productId) LIMIT 10";
