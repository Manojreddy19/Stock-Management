...
public class AdjustmentQueries {
	protected String INSERT_INTO_ADJUSTMENT_HEADER = "INSERT INTO tbl_adjustment_header(AdjustmentId, AdjustmentType, Amount, Status, Remarks, CreatedBy, ModifiedBy) VALUES(:AdjustmentId, :AdjustmentType, :Amount, :Status, :Remarks, :CreatedBy, :ModifiedBy)";
