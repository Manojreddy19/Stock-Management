...
public class AdjustmentDaoImpl extends AdjustmentQueries implements AdjustmentDao {
	...
	public List<Adjustment> getAdjustments() throws StockManagementException {
		try {
			List<Adjustment> getAllAdjustments = namedParameterJdbcTemplate.query(SELECT_ALL_ADJUSTMENTS_BY_CRITERIA,
	...
	@Override
	public List<Adjustment> getAdjustmentsByCriteria(SearchCriteria criteria) throws StockManagementException {
		try {
