...
public class AdjustmentController {
	...
	public List<Adjustment> getAdjusmtent(@RequestBody @Valid SearchCriteria criteria)
	{
		
		 List<Adjustment> adjustments=adjustmentService.getAdjustments(criteria);
	...
	public ResponseEntity<List<StockDetail>> getStocks() {
