...
const AdjustmentForm = () => {
  ...
  const validateFields = (e) => {
    ...
    console.log(newAdjustment.productId);
  ...
  return (
    < div id="main-wrapper">
      ...
      <div id="adjustment-form-container">
        <h2>
          Stock Adjustment:{" "}
          {adjustmentType === "UP" ? "Stock Up" : "Stock Down"}
        </h2>
        <form id="adjustmentForm" onSubmit={validateFields} autoComplete="off">
          <label htmlFor="product_id">
            ...
            <datalist id="productChoices">
              {[...new Set(fetchedData.map((item) => item.productId))].map(
                (productId, idx) => (
