...
public class AdjustmentController {
	...
	public List<Adjustment> getAdjusmtent(@RequestBody @Valid AdjustmentCriteria criteria) {
		try {
			...
			System.out.println("The criteria object received from the frontend form: " + criteria);
			adjustments = adjustmentService.getAdjustmentsByCriteria(criteria);
			System.out.println("My adjustments matching the criteria are: " + adjustments);
			return adjustments;
		} catch (StockManagementException e) {
			return null;
		}
